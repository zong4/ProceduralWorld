...
SurfaceData sampleSurfaceData(float height, vec3 worldPos, vec3 shadingNormal, vec3 sphereDir)
{
    ...
    vec3 mLowGrass = vec3(0.20, 0.86, 0.18);
    vec3 mMeadow = vec3(0.56, 0.90, 0.16);
    vec3 mForestDark = vec3(0.020, 0.38, 0.070);
    vec3 mForestWarm = vec3(0.12, 0.64, 0.10);
    vec3 mSavannaColor = vec3(0.92, 0.72, 0.12);
    vec3 mDrySoil = vec3(0.94, 0.42, 0.12);
    ...
    vec3 mDeepSeabed = vec3(0.08, 0.22, 0.32);
